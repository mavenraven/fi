...
public class GroupRowsTest {
    ...
    public void setUp() {
        Row r1 = new Row(
                ...
                OffsetDateTime.of(
                        LocalDate.parse("2018-03-13"),
                        LocalTime.parse("21:15:01"),
                        ZoneOffset.ofHours(0)));

        Row r2 = new Row(
                Point.fromLngLat(2, -2),
                OffsetDateTime.of(
                        LocalDate.parse("2018-03-13"),
                        LocalTime.parse("21:16:19"),
                        ZoneOffset.ofHours(0)));

        Row r3 = new Row(
                Point.fromLngLat(3, -3),
                OffsetDateTime.of(
                        LocalDate.parse("2018-03-13"),
                        LocalTime.parse("22:16:19"),
                        ZoneOffset.ofHours(0)));

        Row r4 = new Row(
                Point.fromLngLat(99, -99),
                OffsetDateTime.of(
                        LocalDate.parse("2018-03-13"),
                        LocalTime.parse("23:16:20"),
                        ZoneOffset.ofHours(0)));
