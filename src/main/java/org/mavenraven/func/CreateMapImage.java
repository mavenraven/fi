...
public class CreateMapImage implements Function<Walk, BufferedImage> {
  ...
  public BufferedImage apply(Walk walk) {
    try {
      ...
      addDistanceAndDurationLabels(distanceDisplayed, durationDisplayed, image);
      return image;
    } catch (IOException e) {
  ...
  private void addDistanceAndDurationLabels(String distanceDisplayed, String durationDisplayed,
      BufferedImage image) {
