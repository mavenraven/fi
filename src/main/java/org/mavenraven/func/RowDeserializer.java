...
public class RowDeserializer implements Function<CSVRecord, Row> {
    public Row apply(CSVRecord record) {
        return new Row(Point.fromLngLat(Double.parseDouble(record.get(2)), Double.parseDouble(record.get(1))),
